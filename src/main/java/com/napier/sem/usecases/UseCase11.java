...
public class UseCase11 {
    ...
    /**
     * Generates a report with all the cities in a district,
     * organised by largest population to smallest
     */
    public void printCityPopulationReportDESC(String District){
        ...
        //Generate the Report
        System.out.println("UC 11 Report on cities in "+District+" by population");
